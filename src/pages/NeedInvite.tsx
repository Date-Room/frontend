    ...
    <PageShell orbs={false} className="flex items-center justify-center px-6 py-16 overflow-hidden">
      ...
      <div className="max-w-md w-full relative z-10 text-center animate-fade-in">
        <div className="mb-8 relative inline-block">
          <div className="w-20 h-20 rounded-3xl bg-secondary/80 border border-white/5 flex items-center justify-center mx-auto relative z-10 glass-strong">
        ...
        <div className="space-y-4">
          <div className="rounded-2xl p-5 glass grain border border-white/5 text-left">
