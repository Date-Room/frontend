      ...
      <form onSubmit={submit} className="space-y-4">
        <div className="space-y-1.5">
          ...
          <input
            ...
            className="auth-input focus-ring tracking-[0.3em] text-center uppercase"
            autoComplete="off"
            autoFocus
          />
        </div>
        <div className="space-y-1.5">
          ...
          <input
            ...
            className="auth-input focus-ring tracking-[0.5em] text-center"
          />
        </div>
        <button
          type="submit"
          disabled={!valid}
          className="btn-primary focus-ring w-full py-4 rounded-[1.15rem] font-semibold disabled:opacity-40"
        >
          Join
        </button>
      </form>
