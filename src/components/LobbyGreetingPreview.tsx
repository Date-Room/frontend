      ...
      <div className="relative mx-auto aspect-[9/17] max-h-[min(56vh,500px)] w-full max-w-[300px] sm:aspect-[10/17] sm:max-h-[520px] sm:max-w-[320px]">
        ...
        <div className="relative z-10 flex h-full flex-col justify-end px-5 pb-7 pt-10 text-center sm:px-6 sm:pb-8 sm:pt-12">
          ...
          <div className="border-t border-[hsl(35_28%_58%/0.22)] pt-5">
            <p className="mb-3 flex flex-wrap items-center justify-center gap-x-2 italic text-label leading-snug text-[#ecd9bc]/92">
            ...
            <p className="mt-3 font-sans text-label uppercase tracking-[0.22em] text-[#b9a794]/48">
              Illustrative timer
            </p>
            {scheduledPreview ? (
              <p className="mt-2 text-label italic leading-snug text-[#dccfb8]/72">
              ...
              <p className="mt-2 text-label italic leading-snug text-[#a89482]/62">
                Schedule a start time on the previous step to preview the date line here.
              </p>
            )}
          </div>

          <p className="mx-auto mt-6 max-w-[15.5rem] text-label italic leading-relaxed text-[#a89482]/72 sm:mt-7">
            The room unlocks early if your host arrives ahead of time. You&apos;ll be let in automatically.
          </p>
        </div>
      </div>

      <p className="border-t border-[hsl(35_22%_32%/0.28)] bg-[#0a0305]/92 px-4 py-3.5 text-center text-label uppercase tracking-[0.26em] text-[#9e8e82]/95">
